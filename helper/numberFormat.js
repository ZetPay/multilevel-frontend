...
export const strReplace = (source, replace, replaceWith) => {
  ...
  export const getDate = (value, newFormat = null) => {
    ...
    let date = moment(value, formatDefaultLocale).format(newFormat)
    return date
  }
  ...
  export const getDateTime = (value) => {
    let date = moment(value, formatDefaultLocale).format('DD MMMM YYYY HH:mm:ss')
    return date
  }
  
  export const getDateTime2 = (value) => {
    let date = moment(value, formatDefaultLocale).format('DD MMMM YYYY HH:mm')
    return date
  }
  
  export const getFullDay = (value) => {
    let date = moment(value, formatDefaultLocale).format('dddd, DD MMMM YYYY')
    return date
  }
  
  export const getTime = (value) => {
    let date = moment(value, formatDefaultLocale).format('HH:mm:ss')
    return date
  }
  
  export const getHour = (value) => {
    let date = moment(value, formatDefaultLocale).format('HH:mm')
    return date
  }
