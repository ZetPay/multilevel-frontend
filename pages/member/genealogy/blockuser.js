...
export default function Blockuser() {
  ...
  const {member_block_list} = useSelector(state => state.profileReducer);
  ...
  useEffect(() => {
    dispatch(ProfileActions.doGetMemberBlockListRequest())
  },[])
              ...
              <div className="relative flex flex-col min-w-0 break-words w-full mb-6 shadow-lg rounded-lg bg-blueGray-100 border-0">
                <div className="rounded-t bg-white mb-0 px-6 py-6">
                  <div className="text-center flex justify-between">
                    <h6 className="text-blueGray-700 text-xl font-bold">Inactive Users</h6>
                    {/* <button
                ...
                <div className="flex px-4 lg:px-10 py-10 pt-0 bg-white">
                 <Table color="light">
                    <table className="border-collapse items-center w-full bg-transparent">
                      ...
                      <tbody>
                        {
                          member_block_list?.data?.map((y,l) => (
